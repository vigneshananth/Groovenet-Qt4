    ...
    : Q3MainWindow( 0, "MainWindow", Qt::WDestructiveClose )
{
	...
	m_pFileNew = new Q3Action("&New...", Q3Accel::stringToKey("Ctrl+N"), this, "file.new");
	...
	m_pFileEdit = new Q3Action("&Edit...", Q3Accel::stringToKey("Ctrl+E"), this, "file.edit");
	...
	m_pFileOpen = new Q3Action(QPixmap(fileopen), "&Open...", Q3Accel::stringToKey("Ctrl+O"), this, "file.open");
	...
	m_pFileSave = new Q3Action(QPixmap(filesave), "&Save As...", Q3Accel::stringToKey("Ctrl+S"), this, "file.save");
	...
	m_pFileConfig = new Q3Action("&Configure...", QKeySequence(), this, "file.config");
	...
	m_pFileExit = new Q3Action("E&xit...", Q3Accel::stringToKey("Ctrl+Q"), this, "file.exit");
	...
	m_pSimRun = new Q3Action("&Run...", QKeySequence(Qt::Key_F2), this, "sim.run");
	...
	m_pSimPause = new Q3Action("Pause", QKeySequence(Qt::Key_F3), this, "sim.pause");
	...
	m_pSimSkip = new Q3Action("Skip to next", QKeySequence(), this, "sim.skip");
	...
	m_pSimStop = new Q3Action("&Stop", QKeySequence(Qt::SHIFT | Qt::Key_F2), this, "sim.stop");
	...
	m_pNetInit = new Q3Action("&Initialize", QKeySequence(), this, "net.init");
	...
	m_pNetClose = new Q3Action("&Close", QKeySequence(), this, "net.close");
	...
	m_pNetServer = new Q3Action("&Stop Server", QKeySequence(), this, "net.server");
	...
	m_pWindowCascade = new Q3Action("&Cascade", QKeySequence(), this, "window.cascade");
	...
	m_pWindowTile = new Q3Action("&Tile", QKeySequence(), this, "window.tile");
	...
	m_pWindowCloseAll = new Q3Action("Close &All Windows", QKeySequence(), this, "window.closeall");
