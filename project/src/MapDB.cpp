...
void DrawLine(Q3Painter * dc, int sx, int sy, int dx, int dy, int iWidth, const QColor & clrColor, int iStyle)
{
...
void DrawRotatedText(Q3Painter * dc, const QString & str, const QPoint & p, const QSize & sz, double angle, const QColor & clrText)
{
	QPen oldPen(dc->pen());
	dc->setPen(clrText);
	dc->rotate(-angle);
