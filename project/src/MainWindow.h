...
public:
	...
	Q3Action * m_pFileNew, * m_pFileEdit, * m_pFileOpen, * m_pFileSave, * m_pFileConfig, * m_pFileExit, * m_pSimRun, * m_pSimPause, * m_pSimSkip, * m_pSimStop, * m_pNetInit, * m_pNetClose, * m_pNetServer,  * m_pWindowCascade, * m_pWindowTile, * m_pWindowCloseAll;
	QLabel * m_pLblStatus;
